...
/*   Updated: 2023/05/18 11:19:02 by vchakhno         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_u32	ft_array_quicksort_partition(
	t_any_array *array, t_comparison_func func, t_u32 low, t_u32 high
) {
...
static void	ft_array_quicksort(
	t_any_array *array, t_comparison_func func, t_i32 low, t_i32 high
) {
	t_u32	pivot_index;
...
void	ft_array_sort(t_any_array *array, t_comparison_func func)
{
